                ...
                <div className="h-full bg-white dark:bg-black">
                    <div className="flex items-center justify-between px-4 py-3">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                            ...
                            <span className="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">{t('SerPer Interpreter')}</span>
                        </Link>
                            ...
                            <li className="nav-item">
                                <ul>
                                    <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'icerikDuzenle' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('icerikDuzenle')}>
                                            <div className="flex items-center">
                                                ...
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('İçerikleri Düzenle')}</span>
                                            </div>

                                            <div className={currentMenu === 'icerikDuzenle' ? '!rotate-90' : 'rtl:rotate-180'}>
                                        ...
                                        <AnimateHeight duration={300} height={currentMenu === 'icerikDuzenle' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <Link href="/apps/contents/portfoy">{t('Pörtföy')}</Link>
                                                </li>
                                                <li>
                                                    <Link href="/apps/contents/dilHizmetleri">{t('Dil Hizmetleri')}</Link>
                                                </li>
                                            </ul>
                                        </AnimateHeight>
                                    </li>
                                    <li className="nav-item">
                                        <Link href="/apps/comments" className="group">
                                            <div className="flex items-center">
                                                <svg className="group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        opacity="0.5"
                                                ...
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('Yorumlar')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'mesajlar' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('mesajlar')}>
                                            <div className="flex items-center">
                                                <svg className="group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        fillRule="evenodd"
                                                ...
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('Mesajlar')}</span>
                                            </div>
                                            <div className={currentMenu === 'mesajlar' ? '!rotate-90' : 'rtl:rotate-180'}>
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M9 5L15 12L9 19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                </svg>
                                            </div>
                                        ...
                                        <AnimateHeight duration={300} height={currentMenu === 'mesajlar' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <Link href="/apps/message/inComingMessage">{t('Gelen Mesajlar')}</Link>
                                                </li>
                                                <li>
                                                    <Link href="/apps/message/sentMessage">{t('Gönderilen Mesajlar')}</Link>
                                                </li>
                                            </ul>
                                        </AnimateHeight>
                                    </li>
                                    <li className="nav-item">
                                        <Link href="/apps/news/news" className="group">
                                            <div className="flex items-center">
                                                <svg className="group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('Haberler')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    {currentUserProfile && currentUserProfile.status === 2 && (
                                        <li className="nav-item">
                                            <Link href="/apps/users" className="group">
                                                <div className="flex items-center">
                                                    ...
                                                    <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('Kullanıcılar')}</span>
                                                </div>
                                            </Link>
                                        </li>
                                    )}
                                    <hr />
                                    <li className="nav-item">
                                        <Link href="/apps/siteSettings/settings" className="group">
                                            <div className="flex items-center">
                                                <svg className="group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        opacity="0.5"
                                                ...
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('Site Ayarları')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <br />
                                    ...
                                    {/*</li>*/}
                                    {/*<li className="nav-item">*/}
                                    {/*    <Link href="/auth/email-verification" target="_blank">*/}
                                    {/*        Email Onaylama Sonrası Sayfası*/}
                                    {/*    </Link>*/}
                                    {/*</li>*/}
                                    {/*<li className="nav-item">*/}
                                    {/*    <Link href="/auth/password-reset-wait" target="_blank">*/}
                                    {/*        Şifre Resetleme Bekleme Sayfası*/}
                                    {/*    </Link>*/}
                                    {/*</li>*/}
                                    {/*<li className="nav-item">*/}
                                    {/*    <Link href="/auth/forget-password" target="_blank">*/}
                                    {/*        Şifremi Unuttum Mail Giriş Sayfası*/}
                                    {/*    </Link>*/}
                                    {/*</li>*/}
                                    {/*<li className="nav-item">*/}
                                    ...
                                    {/*</li>*/}
                                    {/*<li className="nav-item">*/}
                                    {/*    <Link href="/auth/reset-password" target="_blank">*/}
