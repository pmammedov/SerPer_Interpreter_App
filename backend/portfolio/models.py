...
class PortfolioModel(models.Model):
    ...
    def save(self, *args, **kwargs):
        if self.pk and self.image:
            try:
                old_image = PortfolioModel.objects.get(pk=self.pk).image
        ...
        super(PortfolioModel, self).save(*args, **kwargs)
