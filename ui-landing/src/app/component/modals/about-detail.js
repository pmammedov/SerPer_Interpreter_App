...
const Aboutdetail = ({
  ...
  return (
    <div>
      <Transition.Root show={openMod} as={Fragment}>
        <Dialog
          as="div"
                                    ...
                                    <div className="lg:col-span-7">
                                      <div className="lg:ms-7">
                                        <h6 className="text-orange-600 text-base font-medium uppercase mb-2">
                                          {appLang === "en" && "Who are we ?"}
                                          {appLang === "tr" && "Biz Kimiz ?"}
                                          {appLang === "ar" && "من نحن ؟"}
                                        </h6>
                                        ...
                                        <h4 className="text-slate-400 text-xl dark:text-slate-300 max-w-2xl mx-auto mt-4">
                                          {getLanguage(appLang).walking.header}
                                        </h4>
                                        <p className="text-slate-400 dark:text-slate-300 max-w-2xl mx-auto">
                                          {getLanguage(appLang).walking.content}
                                        </p>
                                        <h4 className="text-slate-400 text-xl dark:text-slate-300 max-w-2xl mx-auto mt-4">
                                          {getLanguage(appLang).team.header}
                                        </h4>
                                        <p className="text-slate-400 dark:text-slate-300 max-w-2xl mx-auto">
                                          {getLanguage(appLang).team.content}
                                        </p>
                                        <p className="text-slate-400 dark:text-slate-300 max-w-2xl mx-auto">
                                          {getLanguage(appLang).partner}
                                        </p>
                                      </div>
                                    </div>
                                  </div>
